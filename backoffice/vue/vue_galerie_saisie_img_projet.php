<?php
include_once('controler/traitement_galerie_saisie_img_projet.php');
?>

<h3 class="mt-5"><?php echo $titre; ?> image pour le projet : <?php echo $projet['nom_projet']; ?></h3>
<div class="row">
    <div class=" mt-3 mb-5 text-start offset-1 col-10">
        <a class="btn btn-camel text-light " href="index.php?page=400&c=3&id=<?php echo $projet['id_projet'] ?>" role="button" >Retour à la galerie image</a>
    </div>
    ...
    <div class="offset-1 col-3">
        ...
        <?php if (isset($image['nom_img'])) {
            ?>
            <img src="../public/assets/img/site/<?php echo $image['nom_img']; ?>" alt="<?php echo $image['nom_img']; ?>" class="img-fluid">
            <?php
        } ?>
    </div>
</div>
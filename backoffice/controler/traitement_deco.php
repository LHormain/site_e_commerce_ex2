...
foreach ($textes as $lignes) {
    ...
    >
        ...
        <td><a href="index.php?page=830&c=5&sc=2&id='.$lignes['id_txt_pf'].'"><img src="public/assets/img/roue-dentee.png" class="icones_table modifier" alt=""></a></td>
        <td><a href="index.php?page=830&c=2&sup='.$lignes['id_txt_pf'].'" onclick="return(confirm(\'Voulez vous supprimer cette entrée ?\'))"><img src="public/assets/img/poubelle.png" class="icones_table supprimer" alt="" ></a></td>
    </tr>
    ';
}
    //images
...
foreach ($images as $lignes) {
    ...
    >
        ...
        <td><a href="index.php?page=830&c=6&sc=2&id='.$lignes['id_img'].'"><img src="public/assets/img/roue-dentee.png" class="icones_table modifier" alt=""></a></td>
        <td><a href="index.php?page=830&c=2&supi='.$lignes['id_img'].'" onclick="return(confirm(\'Voulez vous supprimer cette entrée ?\'))"><img src="public/assets/img/poubelle.png" class="icones_table supprimer" alt="" ></a></td>
    </tr>
    ';
}
